           ...
           tabPanel("Dynamic Map",
                    div(class="outer",
                        ...
                        absolutePanel(id = "controls", class = "panel panel-default", fixed = TRUE,
                                      ...
                                      selectInput("pd", "pick up or drop off", c("Pick up", "Drop off", "All"), 
                                                  selected = "Pick up"),
                                      ...
                                      checkboxInput(inputId = "frequentPos",
                                                    label = strong("Show Nearby Frequent pick up/drop off Fields with A Click"),
                                                    value = FALSE),
                                      
                                      conditionalPanel(condition = "input.frequentPos == true",
                                                       sliderInput("radius_pos", "Set Radius of the Near Fileds:", 
           ...
           tabPanel("Heat Map",
                    div(class="outer",
                        ...
                        sidebarLayout(position = "right", 
                                      sidebarPanel(
                                        h4("Filter"),
                                        sliderInput("Amount", "Number of dropoff location", 1, 10000, 1000, step =1000)
                                      ),
                                      mainPanel(
                                        leafletOutput("heatmap", width = "150%", height = 700)
                                      )
                        )
                    )
           ),
